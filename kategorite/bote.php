...
function displayCategorySlider($category, $subcategory, $link)
{
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<div class="' . strtolower($subcategory) . '-slider">';  // Fix here: Change $category to $subcategory
        echo '<section class="ktg_slider_container">';
        echo '<div class="' . strtolower($subcategory) . '-text">';  // Fix here: Change $category to $subcategory
        echo '<h1 class="' . strtolower($subcategory) . '_sliderH1">';  // Fix here: Change $category to $subcategory
        
        // Adjust the category name based on subcategory
        if ($subcategory === 'eu') {
            echo 'Europe';
        } elseif ($subcategory === 'am') {
            echo 'Amerika';
        }
...
<body>
    ...
    <header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li>
                    <a href="politike.php" class="hA">Showbiz</a>
                </li>
            </ul>
        </nav>
    </header>

    <section class="B_main-section">
        <div class="B_content">
            <p class="B_p">Portal News:</p>
            <h1 class="B_h1">Baneri i Dua Lipes per kengen me te re 'Houdini' shfaqet ne Times Square ne New York</h1>
        </div>
    </section>

    <?php
    displayCategorySlider("Bote", "eu", "kategorite/bote.php");
    displayCategorySlider("Bote", "am", "kategorite/bote.php");
    ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let ballina = document.querySelector(".B_main-section");
