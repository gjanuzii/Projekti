...
<head>
    ...
    .shks_slider_container .container{
    padding: 0 15px;
    max-width: 1230px;
    margin: 0 auto;
    margin-top: -4%;
...
<body>
    ...
    <section class="S_main-section">
        <div class="S_content">
            ...
            <h1 class="S_h1">Koncert i madh ne qytet, yjet e muzikes ne nje shfaqje spektakolare</h1>
        </div>
    </section>

    <?php
    displayCategorySlider("Showbiz", "shks", "kategorite/showbiz_detail.php");
    displayCategorySlider("Showbiz", "bsh", "kategorite/showbiz_detail.php");
    ?>
