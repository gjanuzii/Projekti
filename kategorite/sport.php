...
<body>
    ...
    <section class="S_main-section">
        <div class="S_content">
        <div class="S_content">
            <p class="S_p">Portal News:</p>
            <h1 class="S_h1">Sylvinho: Me Italine presim fitore, me Kroacine ndoshta barazim, Spanja sfida me e madhe</h1>
        </div>
        </div>
    </section>

    <?php
    displayCategorySlider("Sport", "f", "kategorite/sport_detail.php");
    displayCategorySlider("Sport", "basket", "kategorite/sport_detail.php");
    ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let ballina = document.querySelector(".S_main-section");
